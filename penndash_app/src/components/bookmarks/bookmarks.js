  ...
  return (
    <Wrapper>
      ...
      {favoriteRestaurants.length > 0 ? (
              ...
              <RestaurantHeader>
                ...
                <IconWrapper>
                  <Icon onClick={() => toggleFavorite(restaurant.business_id)}>
                    <FaHeart
                      style={{ color: bookmarks[restaurant.business_id] ? 'red' : 'lightgray' }}
                    />
                  </Icon>
                  <Icon onClick={() => toggleBookmark(restaurant.business_id)}>
                    <FaBookmark
                      style={{ color: favorites[restaurant.business_id] ? 'blue' : 'lightgray' }}
                    />
                  </Icon>
                </IconWrapper>
              </RestaurantHeader>
        ...
        <p>No bookmarked restaurants found.</p>
      )}
    </Wrapper>
  );
};
